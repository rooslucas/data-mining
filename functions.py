...
def tree_grow(x, y, nmin, minleaf, nfeat):
    ...
    root = Node("root", parent=None, question=Question(None, None, None)) #root node to be expanded
...
def build_tree(node, x, y, nmin, minleaf, nfeat):
    ...
    if gain == 0 or len(x) < nmin or split == None: #if split == None, no minleaf criteria have been met
        ...
        leaf = Node("leaf " + str(majority_class), parent=node, question=Question(None, None, None))
