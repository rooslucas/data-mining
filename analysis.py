...
pima = np.genfromtxt('pima.txt', delimiter = ',')
...
dt = DecisionTreeClassifier(criterion = 'gini', min_samples_split = 15, min_samples_leaf = 5)
...
rf = RandomForestClassifier(n_estimators = 100, criterion = 'gini', min_samples_split = 15, min_samples_leaf = 5, max_features = 41)
print(f'Accuracy: {accuracy_score(y_test, rf.fit(x_train, y_train).predict(x_test))}')
